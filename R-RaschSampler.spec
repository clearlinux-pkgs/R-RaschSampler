...
export LANG=C
export SOURCE_DATE_EPOCH=1530440312
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library RaschSampler|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/RaschSampler/libs/symbols.rds

%files lib
%defattr(-,root,root,-)
/usr/lib64/R/library/RaschSampler/libs/RaschSampler.so
/usr/lib64/R/library/RaschSampler/libs/RaschSampler.so.avx2
/usr/lib64/R/library/RaschSampler/libs/RaschSampler.so.avx512
